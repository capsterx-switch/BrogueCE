...
BUILD		:=	build
DATA		:=	stuff
SOURCES		:=	src src/brogue  src/platform switch-utils/src
INCLUDES        :=      src src/platform src/brogue switch-utils/include
EXEFS_SRC	:=	exefs_src
...
LIBS	:=	-lSDL2_image -lglapi -lfreetype -lbz2 -lSDL2_image -lpng -lz -ljpeg -lSDL2 \
      -lmodplug -lvorbisfile -lvorbis -logg \
			-lwebp -lEGL -lglapi -ldrm_nouveau  -lm -lnx 
